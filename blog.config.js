...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://magnetic-pot-2e2.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xyz0721', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个“灰”客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xyz0721.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, xyz0721博客', // 网站关键词 英文逗号隔开
